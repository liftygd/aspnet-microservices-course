    ...
    internal class InitialData
    {
        public static IEnumerable<Customer> Customers =>
            new List<Customer>
            {
                ...
                Customer.Create(CustomerId.Of(new Guid("189dc8dc-990f-48e0-a37b-e6f2b60b9d7c")), "gogle", "gogle@gmail.com")
            };
        ...
        public static IEnumerable<Order> OrdersWithItems
        {
            get
            {
                var address1 = Address.Of("jane", "doe", "jane@gmail.com", "Bahcelievler No:4", "Turkey", "Istanbul", "38050");
